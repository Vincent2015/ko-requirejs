define([ 'jquery', 'knockout', 'text!pages/emall/goods/goodinfo.html','uploader','jquery.file.upload','bootstrap'], function($, ko, template,WebUploader) {
	var goodViewModel = {
		good : ko.observable({})
	}
